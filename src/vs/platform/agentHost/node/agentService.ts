...
export class AgentService extends Disposable implements IAgentService {
	...
	async getNetworkDiagnosticsInfo(): Promise<IAgentHostNetworkDiagnosticsInfo> {
		...
		return this._networkDiagnostics.getInfo();
	}
